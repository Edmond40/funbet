...
const AlertDialogTitle = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return (
    <AlertDialogPrimitive.Title ref={ref} className={cn("text-lg font-semibold", className)} {...restProps} />
  );
});
...
const AlertDialogDescription = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return (
    <AlertDialogPrimitive.Description ref={ref} className={cn("text-sm text-muted-foreground", className)} {...restProps} />
  );
});
...
const AlertDialogAction = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return (
    <AlertDialogPrimitive.Action ref={ref} className={cn(buttonVariants(), className)} {...restProps} />
  );
});
