...
const SidebarProvider = React.forwardRef((props, ref) => {
  const { defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, children, ...restProps } = props;
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          className={cn("sidebar-vars group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-sidebar", className)}
          ref={ref}
          {...restProps}
        >
          {children}
...
const Sidebar = React.forwardRef((props, ref) => {
  const { side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...otherProps } = props;
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          side={side}
        >
          <div className="sidebar-vars-mobile flex h-full w-full flex-col">{children}</div>
        </SheetContent>
      </Sheet>
    );
  }
...
const SidebarHeader = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return <div ref={ref} data-sidebar="header" className={cn("flex flex-col gap-2 p-2", className)} {...restProps} />;
});
SidebarHeader.displayName = "SidebarHeader";

const SidebarFooter = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return <div ref={ref} data-sidebar="footer" className={cn("flex flex-col gap-2 p-2", className)} {...restProps} />;
});
...
const SidebarGroupContent = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return <div ref={ref} data-sidebar="group-content" className={cn("w-full text-sm", className)} {...restProps} />;
});
SidebarGroupContent.displayName = "SidebarGroupContent";

const SidebarMenu = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return <ul ref={ref} data-sidebar="menu" className={cn("flex w-full min-w-0 flex-col gap-1", className)} {...restProps} />;
});
SidebarMenu.displayName = "SidebarMenu";

const SidebarMenuItem = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return <li ref={ref} data-sidebar="menu-item" className={cn("group/menu-item relative", className)} {...restProps} />;
});
...
const SidebarMenuButton = React.forwardRef((props, ref) => {
  const { asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...restProps } = props;
  const Comp = asChild ? Slot : "button";
