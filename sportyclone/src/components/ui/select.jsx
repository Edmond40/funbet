...
const SelectLabel = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return (
    <SelectPrimitive.Label ref={ref} className={cn("py-1.5 pl-8 pr-2 text-sm font-semibold", className)} {...restProps} />
  );
});
...
const SelectSeparator = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return (
    <SelectPrimitive.Separator ref={ref} className={cn("-mx-1 my-1 h-px bg-muted", className)} {...restProps} />
  );
});
