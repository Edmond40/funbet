...
const Handball = () => {
  ...
  const [leagues, setLeagues] = useState([
    { id: "all", name: "All", count: 28, checked: true },
    { id: "ehf-cl", name: "EHF Champions League", count: 16, checked: true },
    { id: "bundesliga", name: "Bundesliga", count: 18, checked: true },
    { id: "ehf-el", name: "EHF European League", count: 32, checked: true }
  ]);
  
  const [countries, setCountries] = useState([
    { id: "germany", name: "Germany", count: 18, checked: true },
    { id: "france", name: "France", count: 14, checked: true },
    { id: "spain", name: "Spain", count: 16, checked: true },
    { id: "denmark", name: "Denmark", count: 14, checked: true }
  ]);
          ...
          <div className="flex-1 bg-white">
            <div className="p-4 border-b">
              <div className="flex items-center justify-between">
                <h1 className="text-xl font-semibold">Handball</h1>
                  ...
                  {todayMatches.map((match, index) => (
                    <div key={index} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-b-0">
                      <div className="flex-1">
                        <div className="text-sm text-gray-600">18:00</div>
            ...
            <div className="bg-gray-800 rounded-lg p-4 mb-4">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="bg-green-600 text-white text-xs px-2 py-1 rounded">12</span>
                </div>
                <div className="flex items-center space-x-2">
              ...
              {todayMatches.map((match, index) => (
                <div key={index} className="bg-gray-800 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div className="text-sm text-gray-400">{match.league} • 18:00</div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <span className="text-gray-400 text-sm self-center">+16</span>
                    </div>
                  </div>
                </div>
              ))}
