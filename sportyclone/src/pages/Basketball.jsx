...
const Basketball = () => {
  ...
  const [expandedCountries, setExpandedCountries] = useState(["North America"]);
  const [leagues, setLeagues] = useState([
    { id: "all", name: "All", count: 55, checked: true },
    { id: "wnba", name: "WNBA", count: 3, checked: true },
    { id: "nba", name: "NBA", count: 30, checked: true },
    { id: "euroleague", name: "Euroleague", count: 11, checked: true },
    { id: "champions", name: "Champions League", count: 1, checked: true },
    { id: "basketball-league", name: "Basketball League 25/26", count: 1, checked: true }
  ]);
  
  const [countries, setCountries] = useState([
    { id: "usa", name: "United States", count: 33, checked: true },
    { id: "spain", name: "Spain", count: 8, checked: true },
    { id: "greece", name: "Greece", count: 5, checked: true },
    { id: "turkey", name: "Turkey", count: 4, checked: true },
    { id: "italy", name: "Italy", count: 3, checked: true }
  ]);
  ...
  const handleLeagueClick = (leagueName) => {
    ...
    navigate(`/outrights/basketball/${encodedLeague}`);
  };
  ...
  const outrightLeagues = {
    "North America": [
      { name: "NBA Championship 2024", count: 30 },
      { name: "NBA Regular Season 2024-25", count: 30 },
      { name: "WNBA Championship 2024", count: 12 }
    ],
    "Europe": [
      { name: "EuroLeague Championship 2024", count: 18 },
      { name: "EuroCup 2024", count: 20 },
      { name: "Basketball Champions League 2024", count: 32 }
    ]
  };
          ...
          <div className="flex-1 bg-white">
            ...
            <div className="bg-gray-800 text-white mx-4 mt-4 rounded p-3">
              <div className="flex items-center gap-2">
                ...
                <span className="bg-green-600 text-xs px-2 py-1 rounded">185</span>
              </div>
            </div>
                  ...
                  {activeSection === "Outrights" ? (
                    ...
                    <>
                      <div className="text-sm text-gray-600 mb-3">
                        {activeSection === "Today Games" ? "30/09 Tuesday" : "Upcoming Games"}
                      </div>
                      {getCurrentMatches().map((match, index) => (
                        <div key={index} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-b-0">
                          <div className="flex-1">
                            <div className="text-sm text-gray-600">16:00</div>
                          ...
                          <div className="flex gap-1">
                            <Button size="sm" className="bg-green-600 hover:bg-green-700 text-white px-3 py-1 text-xs min-w-12"
                              onClick={() => addBet({ id: `${index}-1`, event: `${match.homeTeam} vs ${match.awayTeam}`, market: 'Moneyline', pick: match.homeTeam, odds: match.odds.home })}>
                              {match.odds.home}
                            </Button>
                            <Button size="sm" className="bg-green-600 hover:bg-green-700 text-white px-3 py-1 text-xs min-w-12"
                              onClick={() => addBet({ id: `${index}-2`, event: `${match.homeTeam} vs ${match.awayTeam}`, market: 'Moneyline', pick: match.awayTeam, odds: match.odds.away })}>
                              {match.odds.away}
                            </Button>
