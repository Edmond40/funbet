...
const TableTennis = () => {
  ...
  const [leagues, setLeagues] = useState([
    { id: "all", name: "All", count: 25, checked: true },
    { id: "ittf", name: "ITTF World Tour", count: 12, checked: true },
    { id: "wtt", name: "WTT Champions", count: 8, checked: true },
    { id: "european", name: "European Championships", count: 5, checked: true }
  ]);
  
  const [countries, setCountries] = useState([
    { id: "china", name: "China", count: 10, checked: true },
    { id: "germany", name: "Germany", count: 5, checked: true },
    { id: "japan", name: "Japan", count: 4, checked: true },
    { id: "sweden", name: "Sweden", count: 3, checked: true },
    { id: "korea", name: "South Korea", count: 3, checked: true }
  ]);
  ...
  const handleLeagueClick = (leagueName) => {
    ...
    navigate(`/outrights/table-tennis/${encodedLeague}`);
  };
  ...
  const outrightLeagues = {
    "International": [
      { name: "ITTF World Championships 2024", count: 128 },
      { name: "World Table Tennis Championships 2025", count: 64 },
      { name: "Olympic Games 2024", count: 32 }
    ],
    "Tours": [
      { name: "ITTF World Tour 2024", count: 12 },
      { name: "WTT Champions Series 2024", count: 8 },
      { name: "European Championships 2024", count: 32 }
    ]
  };
          ...
          <div className="flex-1 bg-white">
            <div className="p-4 border-b">
              <div className="flex items-center justify-between">
                <h1 className="text-xl font-semibold">Table Tennis</h1>
            ...
            <div className="bg-gray-800 text-white mx-4 mt-4 rounded p-3">
              <div className="flex items-center gap-2">
                ...
                <span className="bg-green-600 text-xs px-2 py-1 rounded">8</span>
              </div>
            </div>
                  ...
                  {activeSection === "Outrights" ? (
                    ...
                    <>
                      <div className="text-sm text-gray-600 mb-3">
                        {activeSection === "Today Games" ? "Today's Matches" : "Upcoming Games"}
                      </div>
                      {getCurrentMatches().map((match, index) => (
                        <div key={index} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-b-0">
                          <div className="flex-1">
                            <div className="text-sm text-gray-600">15:30</div>
