...
const Rugby = () => {
  ...
  const [leagues, setLeagues] = useState([
    { id: "all", name: "All", count: 38, checked: true },
    { id: "six-nations", name: "Six Nations", count: 6, checked: true },
    { id: "rugby-championship", name: "Rugby Championship", count: 4, checked: true },
    { id: "world-cup", name: "Rugby World Cup", count: 20, checked: true },
    { id: "premiership", name: "Premiership", count: 12, checked: true }
  ]);
  
  const [countries, setCountries] = useState([
    { id: "england", name: "England", count: 12, checked: true },
    { id: "france", name: "France", count: 14, checked: true },
    { id: "wales", name: "Wales", count: 4, checked: true },
    { id: "ireland", name: "Ireland", count: 4, checked: true },
    { id: "scotland", name: "Scotland", count: 4, checked: true }
  ]);
          ...
          <div className="flex-1 bg-white">
            <div className="p-4 border-b">
              <div className="flex items-center justify-between">
                <h1 className="text-xl font-semibold">Rugby</h1>
              ...
              {todayMatches.map((match, index) => (
                <div key={index} className="bg-gray-800 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div className="text-sm text-gray-400">{match.league} • 15:00</div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <span className="text-gray-400 text-sm self-center">+22</span>
                    </div>
                  </div>
                </div>
              ))}
