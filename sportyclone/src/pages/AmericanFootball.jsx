...
const AmericanFootball = () => {
  ...
  const [leagues, setLeagues] = useState([
    ...
    { id: "nfl", name: "NFL", count: 32, checked: true },
    { id: "college", name: "College Football", count: 130, checked: true },
    { id: "cfl", name: "CFL", count: 9, checked: true }
  ]);
  
  const [countries, setCountries] = useState([
    { id: "usa", name: "United States", count: 162, checked: true },
    { id: "canada", name: "Canada", count: 9, checked: true }
  ]);
  ...
  useEffect(() => {
    const handleBetAdded = () => {
      // Removed the setBetCount state and the related code
    };
          ...
          <div className="flex-1 bg-white">
            <div className="p-4 border-b">
              <div className="flex items-center justify-between">
                <h1 className="text-xl font-semibold">American Football</h1>
            ...
            <div className="bg-gray-800 text-white mx-4 mt-4 rounded p-3">
              <div className="flex items-center gap-2">
                ...
                <span className="bg-green-600 text-xs px-2 py-1 rounded">6</span>
              </div>
            </div>
            ...
            <div className="mx-4 mt-6 border rounded">
              ...
              <div className="p-3">
                <div className="space-y-3">
                  <div className="text-sm text-gray-600 mb-3">Today's Games</div>
            ...
            <div className="bg-gray-800 rounded-lg p-4 mb-4">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="bg-green-600 text-white text-xs px-2 py-1 rounded">6</span>
                </div>
                <div className="flex items-center space-x-2">
              ...
              {todayMatches.map((match, index) => (
                <div key={index} className="bg-gray-800 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div className="text-sm text-gray-400">{match.league} • 15:30</div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
