...
const Baseball = () => {
  ...
  const [leagues, setLeagues] = useState([
    ...
    { id: "mlb", name: "MLB", count: 30, checked: true },
    { id: "npb", name: "NPB", count: 12, checked: true },
    { id: "kbo", name: "KBO", count: 10, checked: true }
  ]);
  
  const [countries, setCountries] = useState([
    { id: "usa", name: "United States", count: 30, checked: true },
    { id: "japan", name: "Japan", count: 12, checked: true },
    { id: "korea", name: "South Korea", count: 10, checked: true },
    { id: "cuba", name: "Cuba", count: 8, checked: true }
  ]);
          ...
          <div className="flex-1 bg-white">
            <div className="p-4 border-b">
              <div className="flex items-center justify-between">
                <h1 className="text-xl font-semibold">Baseball</h1>
                  ...
                  {todayMatches.map((match, index) => (
                    <div key={index} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-b-0">
                      <div className="flex-1">
                        <div className="text-sm text-gray-600">19:05</div>
              ...
              {todayMatches.map((match, index) => (
                <div key={index} className="bg-gray-800 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div className="text-sm text-gray-400">{match.league} • 19:05</div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
