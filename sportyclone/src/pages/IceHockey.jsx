...
const IceHockey = () => {
  ...
  const [leagues, setLeagues] = useState([
    { id: "all", name: "All", count: 42, checked: true },
    { id: "nhl", name: "NHL", count: 30, checked: true },
    { id: "khl", name: "KHL", count: 8, checked: true },
    { id: "shl", name: "SHL", count: 4, checked: true }
  ]);
  
  const [countries, setCountries] = useState([
    { id: "usa", name: "United States", count: 25, checked: true },
    { id: "canada", name: "Canada", count: 7, checked: true },
    { id: "russia", name: "Russia", count: 6, checked: true },
    { id: "sweden", name: "Sweden", count: 4, checked: true }
  ]);
  ...
  // Removed old desktop-specific code that's no longer needed
          ...
          <div className="flex-1 bg-white">
            <div className="p-4 border-b">
              <div className="flex items-center justify-between">
                <h1 className="text-xl font-semibold">Ice Hockey</h1>
            ...
            <div className="bg-gray-800 text-white mx-4 mt-4 rounded p-3">
              <div className="flex items-center gap-2">
                ...
                <span className="bg-green-600 text-xs px-2 py-1 rounded">18</span>
              </div>
            </div>
            ...
            <div className="mx-4 mt-6 border rounded">
              ...
              <div className="p-3">
                <div className="space-y-3">
                  <div className="text-sm text-gray-600 mb-3">30/09 Tuesday</div>
                  {todayMatches.map((match, index) => (
                    <div key={index} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-b-0">
                      <div className="flex-1">
                        <div className="text-sm text-gray-600">19:00</div>
            ...
            <div className="bg-gray-800 rounded-lg p-4 mb-4">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="bg-green-600 text-white text-xs px-2 py-1 rounded">18</span>
                </div>
                <div className="flex items-center space-x-2">
