...
const MMA = () => {
  ...
  const [leagues, setLeagues] = useState([
    { id: "all", name: "All", count: 22, checked: true },
    { id: "ufc", name: "UFC", count: 12, checked: true },
    { id: "bellator", name: "Bellator", count: 6, checked: true },
    { id: "pfl", name: "PFL", count: 4, checked: true }
  ]);

  const [countries, setCountries] = useState([
    { id: "international", name: "International", count: 10, checked: true },
    { id: "north-america", name: "North America", count: 8, checked: true },
  ...
  const handleLeagueClick = (leagueName) => {
    ...
    navigate(`/outrights/mma/${encodedLeague}`);
  };
  ...
  const outrightLeagues = {
    "International": [
      { name: "UFC Heavyweight Championship", count: 8 },
      { name: "UFC Light Heavyweight Championship", count: 6 },
      { name: "UFC Middleweight Championship", count: 10 },
      { name: "UFC Welterweight Championship", count: 12 }
    ],
    "North America": [
      { name: "Bellator Heavyweight Championship", count: 6 },
      { name: "Bellator Light Heavyweight Championship", count: 5 },
      { name: "ONE Championship Heavyweight", count: 8 },
      { name: "PFL Championship 2024", count: 10 }
    ]
  };
          ...
          <div className="flex-1 bg-white">
            <div className="p-4 border-b">
              <div className="flex items-center justify-between">
                <h1 className="text-xl font-semibold">MMA</h1>
            ...
            <div className="bg-gray-800 text-white mx-4 mt-4 rounded p-3">
              <div className="flex items-center gap-2">
                ...
                <span className="bg-green-600 text-xs px-2 py-1 rounded">5</span>
              </div>
            </div>
                  ...
                  {activeSection === "Outrights" ? (
                    ...
                    <>
                      <div className="text-sm text-gray-600 mb-3">
                        {activeSection === "Today Games" ? "Today's MMA Fights" : "Upcoming MMA Fights"}
                      </div>
                      {getCurrentMatches().map((match, index) => (
                        <div key={index} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-b-0">
                          <div className="flex-1">
                            <div className="text-sm text-gray-600">22:00</div>
              ...
              {todayMatches.map((match, index) => (
                <div key={index} className="bg-gray-800 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div className="text-sm text-gray-400">{match.league} • 22:00</div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
